...
public class UIUtils {
    ...
    public static AlertDialog getProgressDialog(Activity activity, int layoutResource){
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        final View view = LayoutInflater.from(activity).inflate(layoutResource, null);
        View img1 = view.findViewById(R.id.pd_circle1);
        View img2 = view.findViewById(R.id.pd_circle2);
        View img3 = view.findViewById(R.id.pd_circle3);
        int ANIMATION_DURATION = 400;
    ...
    public static MaterialDialog getMaterialDialog(Activity activity, int layoutResource){
